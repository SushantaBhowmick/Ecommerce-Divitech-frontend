                            ...
                            <div className="checkout-left-data">
                                ...
                                >
                                    <ol className="breadcrumb">
                                        ...
                                        <li className="breadcrumb-item total-price active" aria-label='page'>
                                            Payment
                                        </li>
                                ...
                                <p className="user-details total">Sushanta Bhowmick (mymaildevelper1@gmail.com)</p>
                                ...
                                <div className="d-flex gap-10 mb-2 align-items-center">
                                    <div className='w-75 d-flex gap-10'>
                                        <div className='w-25 position-relative'>
                                            ...
                                            <img src={watch} alt="proudctImg" className='img-fluid' />
                                        </div>
                                        <div>
                                            <h5 className="total-price">titele</h5>
                                            <p className='total-price'>sfosaih</p>
                                        </div>
                                    </div>
                                    <div className="flex-grow-1">
